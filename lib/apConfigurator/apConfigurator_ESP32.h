#ifndef APCONFIGURATOR_ESP32_H
#define APCONFIGURATOR_ESP32_H
    ...
    */
    #define TRIGGER_PIN PIN_D0   // Pin D0 mapped to pin GPIO0/BOOT/ADC11/TOUCH1 of ESP32
    /*
    Alternative trigger pin. Needs to be connected to a button to use this pin. It must be a momentary connection
    not connected permanently to ground. Either trigger pin will work.
    */
    #define TRIGGER_PIN2  PIN_D25 // Pin D25 mapped to pin GPIO25/ADC18/DAC1 of ESP32
#endif //APCONFIGURATOR_ESP32_H
